...
Yes. It is advised to maintain the default `0.0001 ZEC` fee to prevent your transactions from being distinguishable in the ledger. However, you can find the custom fee picker inside of the `Advanced Options` on the `Send` view.
...
Not yet, as `zcashd` doesn’t currently support Sapling viewing keys.
